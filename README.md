...
- Firmware et SPIFFS recompiles avec la version `2.1.0` integree.
...
- Session HMI UDP liee au pair authentifie; un token vide est refuse.
...
- `binary/esp32s3-2.1.0.bin` : firmware Waveshare ESP32-S3.
- `binary/esp32s3-spiffs-2.1.0.bin` : interface web / SPIFFS.
