...
constexpr char User[] = "web_usr"; // Web administration user.
constexpr char Pass[] = "web_pass"; // Web administration password.
}  // namespace WebSecurity
...
constexpr char TankLevelMonitoringEnabled[] = "pl_tlme"; // Pool logic module persisted key for tank level monitoring enable.
constexpr char FiltrationFeedbackIoId[] = "pl_ffid"; // Filtration contactor feedback logical IO id.
constexpr char ChlorineGeneratorFeedbackIoId[] = "pl_cfid"; // Chlorine generator contactor feedback logical IO id.
constexpr char FiltrationFeedbackMonitoringEnabled[] = "pl_ffme"; // Filtration contactor feedback monitoring enable.
constexpr char ChlorineGeneratorFeedbackMonitoringEnabled[] = "pl_cfme"; // Chlorine generator contactor feedback monitoring enable.
