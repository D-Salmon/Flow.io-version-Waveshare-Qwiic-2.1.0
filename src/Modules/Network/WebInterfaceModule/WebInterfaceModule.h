...
private:
    ...
    void handleLocalUpdateUpload_(AsyncWebServerRequest* request,
                                  ...
                                  bool final,
                                  bool spiffsTarget);
    void handleLocalUpdateComplete_(AsyncWebServerRequest* request, bool spiffsTarget);
    ...
    bool websocketHandshakeAllowed_(AsyncWebServerRequest* request) const;
    ...
    ConfigVariable<char,0> webAdminUserVar_{
        NVS_KEY(NvsKeys::WebSecurity::User), "user", "websec",
        ConfigType::CharArray, webSecurity_.user, ConfigPersistence::Persistent, sizeof(webSecurity_.user)
    };
    ConfigVariable<char,0> webAdminPassVar_{
        NVS_KEY(NvsKeys::WebSecurity::Pass), "pass", "websec",
        ConfigType::CharArray, webSecurity_.pass, ConfigPersistence::Persistent, sizeof(webSecurity_.pass)
    };
    bool webCredentialsReady_ = false;
    char csrfToken_[33] = {0};
    static constexpr uint8_t kWebAuthThrottleSlots = 6U;
    static constexpr uint8_t kWebAuthMaxFailures = 5U;
    static constexpr uint32_t kWebAuthWindowMs = 60000U;
    static constexpr uint32_t kWebAuthBlockMs = 60000U;
    struct WebAuthThrottleEntry {
        ...
        uint8_t failures = 0U;
        bool used = false;
    } webAuthThrottle_[kWebAuthThrottleSlots]{};
    ...
    bool localUpdateActive_ = false;
    bool localUpdateSuccess_ = false;
    bool localUpdateSpiffs_ = false;
    size_t localUpdateBytes_ = 0;
    char localUpdateError_[96] = {0};
    mbedtls_sha256_context localUpdateSha256_{};
    bool localUpdateSha256Active_ = false;
    char localUpdateSignature_[128] = {0};
