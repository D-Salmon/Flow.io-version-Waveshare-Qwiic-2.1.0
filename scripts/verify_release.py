...
def verify_security_defaults() -> None:
    ...
    hmi = (ROOT / "src/Modules/Network/HmiUdpServerModule/HmiUdpServerModule.cpp").read_text(
        encoding="utf-8"
    )
    ...
    required = (
        ...
        ("HMI authenticated session", "sessionAuthenticated_", hmi),
        ("HMI empty-token default-off", "#define FLOW_HMI_ALLOW_EMPTY_TOKEN 0", hmi),
